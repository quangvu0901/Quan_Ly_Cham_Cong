<div class="w-full p-1 md:p-4">
    <x-lf.card title="Edit" class="warning">
        ...
        <x-slot name="tools" >
            ...
            <a class="btn-success sm" href="{{route('admin.permissions.show',$record_id)}}">{!! lfIcon("launch",11) !!}</a>
            @endcan
            <a class="btn-primary sm" href="{{route('admin.permissions')}}">{!! lfIcon("list",11) !!}</a>
        </x-slot>
        <x-slot name="footer">
