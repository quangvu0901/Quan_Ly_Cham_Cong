...
class   Create extends Component
{
    ...
    public function store()
    {
        ...
        if ($data) {
            $this->redirectForm("admin.permissions", $data->id,['module'=>$this->module]);
        }
    }
    ...
    public function render()
    {
		...
		lForm()->pushBreadcrumb(route("admin.permissions.create"),"Create");
        ...
        return view("admin::livewire.permissions.create",compact("modules","permissions","parents"))
