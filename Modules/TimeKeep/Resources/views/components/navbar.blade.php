<div id="lf-menu">
    <ul id="navbar">
        <li class="item {{ request()->routeIs('time-keep')? 'active' : '' }} ">
            <a href="{{route('time-keep')}}" class="link"><span class="icon">{!! lfIcon("home") !!}</span><span class="link-title">Time Keep</span></a>
        </li>
